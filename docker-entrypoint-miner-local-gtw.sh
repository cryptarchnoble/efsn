...
cmd_options_local_gtw=' --identity 1 --http --http.api=eth,net,fsn,fsntx --http.addr=0.0.0.0 --http.port=9000 --http.corsdomain=* --http.vhosts=* --ws --ws.api=eth,net,fsn,fsntx --ws.addr=0.0.0.0 --ws.port=9001 --ws.origins=*'
